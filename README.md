...
├── rss.py          → feedparser
├── exa_search.py   → Exa REST（个人 Key）▸ Exa via mcporter
...
| 搜全网 | [Exa](https://exa.ai) REST（个人 Key） | [mcporter](https://github.com/nicobailon/mcporter) MCP（免 Key） | 有 Key 时直连减少中间传输；未配置时保留零配置路径 |
