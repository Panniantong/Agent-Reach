...
| 📕 **XiaoHongShu** | 읽기 · 검색 · 댓글 | OpenCLI / MCP | 데스크톱: [OpenCLI](https://github.com/jackwener/opencli) (브라우저 세션 재사용); 서버: [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) (QR 로그인) |
| 📘 **Facebook** | 검색 · 프로필 · 피드 · 그룹 목록 | OpenCLI | 데스크톱 전용: [OpenCLI](https://github.com/jackwener/opencli)가 Chrome 로그인 세션 재사용 |
| 📷 **Instagram** | 사용자 검색 · 프로필 · 최근 게시물 · Explore | OpenCLI | 데스크톱 전용: [OpenCLI](https://github.com/jackwener/opencli)가 Chrome 로그인 세션 재사용 |
...
| 📺 **Bilibili** | 읽기 · **검색** | 없음 | [bili-cli](https://github.com/public-clis/bilibili-cli)로 검색 + 비디오 상세 (로그인 불필요); 자막은 OpenCLI |
| 📡 **RSS** | 읽기 | 없음 | 모든 RSS/Atom 피드 ([feedparser](https://github.com/kurtmckee/feedparser) ⭐2.3K) |
| 📖 **Reddit** | 검색 · 읽기 | OpenCLI / Cookie | 제로 설정 경로 없음 (익명 API 차단). 데스크톱: OpenCLI 브라우저 세션; 또는 [rdt-cli](https://github.com/public-clis/rdt-cli) + Cookie |
...
| 시나리오 | 기본 | 대체 | 이유 |
|----------|------|------|------|
| 웹 페이지 읽기 | [Jina Reader](https://github.com/jina-ai/reader) | — | 무료, API key 불필요 |
| 트윗 읽기 | [twitter-cli](https://github.com/public-clis/twitter-cli) | [OpenCLI](https://github.com/jackwener/opencli) | 실사용 검색 안정성; OpenCLI는 브라우저 세션으로 대체 |
| Reddit | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | [rdt-cli](https://github.com/public-clis/rdt-cli) | 익명 API 차단, 로그인 세션 필요 |
| Facebook | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | — | Graph/Groups API 제한, 브라우저 세션이 실용적 |
| Instagram | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | Official Graph API | OpenCLI가 실제 브라우저 세션 재사용 |
| YouTube 자막 + 검색 | [yt-dlp](https://github.com/yt-dlp/yt-dlp) | — | YouTube 전용 (Bilibili에는 더 이상 사용 안 함) |
| Bilibili | [bili-cli](https://github.com/public-clis/bilibili-cli) | OpenCLI ▸ search API | yt-dlp는 Bilibili 412 차단 (2026-06 검증) |
...
| RSS 읽기 | [feedparser](https://github.com/kurtmckee/feedparser) | — | Python 생태계 표준 |
| XiaoHongShu | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) (server) ▸ xhs-cli | 브라우저 세션으로 마찰 최소화 |
| LinkedIn | [linkedin-scraper-mcp](https://github.com/stickerdaniel/linkedin-mcp-server) | Jina Reader | MCP 서버, 브라우저 자동화 |
