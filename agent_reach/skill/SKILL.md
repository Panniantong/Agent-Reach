...
description: >
  ...
  Lobsters, LinkedIn/领英/招聘/求职/jobs, YouTube, GitHub code search,
  ...
  分类：search / social (小红书/推特/B站/V2EX/Reddit/Lobsters) / career(LinkedIn) / dev(github) / web(网页/文章/RSS) / video(YouTube/B站/播客)。
triggers:
...
| 小红书/推特/B站/V2EX/Reddit/Lobsters | social | [references/social.md](references/social.md) |
...
- [社交媒体](references/social.md) — 小红书, Twitter, B站, V2EX, Reddit, Lobsters（多后端命令组）
