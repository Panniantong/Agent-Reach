...
| 💼 **LinkedIn** | Public pages · Profiles · Companies · Job search | Jina Reader for public pages · mcp-server-linkedin for full access | Tell your Agent "help me set up LinkedIn" |
| 🔎 **Indeed** | Structured job search · Public job pages | JobSpy MCP for search · Jina Reader for single pages | Tell your Agent "help me set up Indeed" |
