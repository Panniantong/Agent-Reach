...
class XueqiuChannel(Channel):
    name = "xueqiu"
    description = "Xueqiu stock quotes and community"
    ...
    def check(self, config=None):
        ...
        try:
            ...
            return "warn", "API response abnormal (returned empty data)"
        except Exception as e:
            return "warn", (
                f"Xueqiu API connection failed: {e}. "
                "First log into Xueqiu, then run: agent-reach configure --from-browser chrome"
            )
