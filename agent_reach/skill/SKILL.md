...
description: >
  ...
  LinkedIn/领英/招聘/求职/jobs, YouTube, GitHub code search, Stack Overflow,
  ...
  分类：search / social (小红书/推特/B站/V2EX/Reddit) / career(LinkedIn) / dev(github/Stack Overflow) / web(网页/文章/RSS) / video(YouTube/B站/播客)。
triggers:
  ...
  - dev: github/代码/仓库/gh/issue/pr/分支/commit/stackoverflow/stack overflow/so/报错/异常/怎么解决
...
| GitHub/代码/Stack Overflow/报错 | dev | [references/dev.md](references/dev.md) |
...
# Stack Overflow 搜索（Stack Exchange API，无需 key；匿名约 300 次/天）
...
- [开发工具](references/dev.md) — GitHub CLI, Stack Overflow
