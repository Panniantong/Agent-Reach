...
description: >
  ...
  Xiaoyuzhou Podcast, LinkedIn/jobs/recruiting, V2EX, Stack Overflow,
  Xueqiu (stocks), RSS.
...
| GitHub / code / Stack Overflow | dev | [references/dev.md](references/dev.md) |
...
# Stack Overflow search (Stack Exchange API, no key; ~300 req/day anon)
...
- [Dev](references/dev.md) — GitHub CLI, Stack Overflow
