...
| 🐦 **Twitter/X** | 閲覧・検索 | Cookie | Cookieで検索、タイムライン、投稿が解放（[twitter-cli](https://github.com/public-clis/twitter-cli)） |
| 📕 **小紅書** | 閲覧・検索・コメント | OpenCLI / MCP | デスクトップ: [OpenCLI](https://github.com/jackwener/opencli)（ブラウザセッション再利用）; サーバー: [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)（QRログイン） |
| 📘 **Facebook** | 検索・プロフィール・フィード・グループ一覧 | OpenCLI | デスクトップ専用: [OpenCLI](https://github.com/jackwener/opencli)がChromeログインセッションを再利用 |
| 📷 **Instagram** | ユーザー検索・プロフィール・最近の投稿・Explore | OpenCLI | デスクトップ専用: [OpenCLI](https://github.com/jackwener/opencli)がChromeログインセッションを再利用 |
...
| 📺 **Bilibili** | 閲覧・**検索** | 設定不要 | [bili-cli](https://github.com/public-clis/bilibili-cli)で検索+動画詳細（ログイン不要）; 字幕はOpenCLI |
| 📡 **RSS** | 閲覧 | 設定不要 | 任意のRSS/Atomフィード（[feedparser](https://github.com/kurtmckee/feedparser) ⭐2.3K） |
| 📖 **Reddit** | 検索・閲覧 | OpenCLI / Cookie | ゼロ設定パスなし（匿名APIはブロック）。デスクトップ: OpenCLIブラウザセッション; または [rdt-cli](https://github.com/public-clis/rdt-cli) + Cookie |
...
| シナリオ | プライマリ | フォールバック | 理由 |
|----------|------------|----------------|------|
| Webページ閲覧 | [Jina Reader](https://github.com/jina-ai/reader) | — | 無料、APIキー不要 |
| ツイート閲覧 | [twitter-cli](https://github.com/public-clis/twitter-cli) | [OpenCLI](https://github.com/jackwener/opencli) | 実運用での検索安定性; OpenCLIはブラウザセッションで代替 |
| Reddit | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | [rdt-cli](https://github.com/public-clis/rdt-cli) | 匿名APIブロック、ログインセッションが必要 |
| Facebook | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | — | Graph/Groups API制限、ブラウザセッションが実用的 |
| Instagram | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | Official Graph API | OpenCLIが実ブラウザセッションを再利用 |
| YouTube字幕 + 検索 | [yt-dlp](https://github.com/yt-dlp/yt-dlp) | — | YouTube専用（Bilibiliには使用しない） |
| Bilibili | [bili-cli](https://github.com/public-clis/bilibili-cli) | OpenCLI ▸ search API | yt-dlpはBilibili 412ブロック（2026-06検証） |
...
| RSS閲覧 | [feedparser](https://github.com/kurtmckee/feedparser) | — | Pythonエコシステムの標準 |
| 小紅書 | [OpenCLI](https://github.com/jackwener/opencli) (desktop) | [xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp) (server) ▸ xhs-cli | ブラウザセッションで摩擦最小化 |
| LinkedIn | [linkedin-scraper-mcp](https://github.com/stickerdaniel/linkedin-mcp-server) | Jina Reader | MCPサーバー、ブラウザ自動化 |
...
[twitter-cli](https://github.com/public-clis/twitter-cli) · [rdt-cli](https://github.com/public-clis/rdt-cli) · [xhs-cli](https://github.com/jackwener/xiaohongshu-cli) · [bili-cli](https://github.com/public-clis/bilibili-cli) · [Jina Reader](https://github.com/jina-ai/reader) · [yt-dlp](https://github.com/yt-dlp/yt-dlp) · [Exa](https://exa.ai) · [feedparser](https://github.com/kurtmckee/feedparser) · [linkedin-scraper-mcp](https://github.com/stickerdaniel/linkedin-mcp-server)
